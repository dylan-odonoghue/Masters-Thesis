...
%slippery packages that need to come first, since others call them after
...
\usepackage{dsfont}
%\usepackage{etex} % probably not needed
\usepackage{fancyhdr}
\usepackage{fix-cm}
...
%\usepackage{braket} %seems to be incompatible with quantikz :(
%\usepackage{physics} %seems to be incompatible with quantikz :(
\usepackage{tikz}
\usetikzlibrary{graphs, graphs.standard, positioning}
\definecolor{orangegraph}{RGB}{230,145,56}
