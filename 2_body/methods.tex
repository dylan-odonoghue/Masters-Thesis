...
The hyperparameters were selected by the optimisation procedure outlined in section \ref{sec:parameters}, beginning with the arbitrarily chosen initial parameters $\gamma=0.5, t=0.5, \beta=0.4$.\todo{not arbitrary}
