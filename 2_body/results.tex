...
It is evident from Figure \ref{fig:osp} that the NVQWOA performs well in the average case to increase the probability of measuring the optimal solution. In the previous section, the fixed hyperparameter problem amplified its OSP from  to the optimised hyperparameters in the equivalent $n=9$ problem set here, we see that the final optimal solution probability has increased on a 0.06366 to 0.23 for OSP, and 0.07 for EV and CVaR.
